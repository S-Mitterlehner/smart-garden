...
public class HumidityModuleConnector(string key, IConnectionMultiplexer redis, ILogger<HumidityModuleConnector> logger) : BaseSensorApiModuleConnector(key, redis, logger)
{
