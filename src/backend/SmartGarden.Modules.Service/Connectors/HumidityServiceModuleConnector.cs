...
public class HumidityServiceModuleConnector(string key, string topic, IMqttClient mqtt, IModuleListener listener) 
    : BaseSensorServiceModuleConnector(key, topic, mqtt, listener)
{
