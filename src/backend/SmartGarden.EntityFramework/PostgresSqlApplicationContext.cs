...
public class PostgresSqlApplicationContext(DbContextOptions options, ConnectionStrings connStrings) : ApplicationContext(options)
{
...
public class PostgresSqlApplicationDesignTimeFactory(IServiceProvider serviceProvider) 
    : BaseApplicationContextDesignTimeFactory<PostgresSqlApplicationContext>(serviceProvider);